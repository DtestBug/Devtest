    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include', models.TextField(help_text='包含的项目', verbose_name='包含的接口')),
                ('project', models.ForeignKey(help_text='所属项目', on_delete=django.db.models.deletion.CASCADE, related_name='testsuits', to='project.Project_Mo')),
            ],
            options={
                'verbose_name': '套件信息',
