...
class Testcases(BaseModel):
    ...
    interface = models.ForeignKey('interface.Interface_Mo', on_delete=models.CASCADE, help_text='所属接口', related_name='testcases')

    include = models.TextField('前置', null=True, help_text='用例执行前置顺序')  # null=true可以设置为空
