...
class Project(View):
    ...
    def post(self,request):
        ...
        try:
            ...
            ret['msg'] = '参数有误'
            ret.update(res.errors)
            return JsonResponse(ret,status=400,safe=False)
...
class Projects(View):
    ...
    def get(self,request):
        ...
        return JsonResponse(ProjectModelSerializer(instance=Project_Mo.objects.all(), json_dumps_params={"ensure_ascii": False}, many=True).data, safe=False)
